...
import type {BucketsMs} from "@charts/charts/core/types/chart.types.ts";
import type {GetMultiSeriesRequest} from "@charts/charts/shared/dtos/requests/GetMultiSeriesRequest.ts";
import type {FieldDto} from "@charts/metaData/shared/dtos/FieldDto.ts";
import type {MultiSeriesResponse} from "@charts/charts/shared/dtos/responses/MultiSeriesResponse.ts";
