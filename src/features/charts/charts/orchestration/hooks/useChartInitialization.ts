...
import { selectTemplate } from '@charts/charts/core/store/selectors/base.selectors';
import {fetchMultiSeriesInit} from "@charts/charts/orchestration/thunks/initThunks.ts";
import {InitializationService} from "@charts/charts/orchestration/services/InitializationService.ts";
import {useAppDispatch, useAppSelector} from "@/store/hooks.ts";
import {selectBucketing} from "@charts/charts/core/store/chartsSettingsSlice.ts";
import {
    initialViews
