...
import { fetchMultiSeriesInit } from '@chartsPage/store/thunks';
import { selectTimeSettings, selectIsDataLoaded } from '@chartsPage/store/selectors.ts';
import type { ResolvedCharReqTemplate } from '@chartsPage/template/shared/contracts/chartTemplate/Dtos/ResolvedCharReqTemplate';
import type { GetMultiSeriesRequest } from '@chartsPage/template/shared/contracts/chart/Dtos/Requests_/GetMultiSeriesRequest';
import styles from './ChartCollection.module.css';
import { formatDateWithTimezone } from "@chartsPage/ui/TimeZonePicker/timezoneUtils.ts";
import {
    ResizableContainer,
    SyncGroupControl
} from "@chartsPage/ui/CharContainer/ChartCollection/ResizableContainer/ResizableContainer.tsx";
import FieldChart from "@chartsPage/ui/CharContainer/ChartCollection/FieldChart/FieldChart.tsx";
