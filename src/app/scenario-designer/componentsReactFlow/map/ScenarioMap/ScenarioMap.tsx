...
import { nodeTypes as nodeTypesRegistry } from '@app/scenario-designer/core/contracts/types/nodeTypes.ts'

// панели
import { RightPanel } from '@app/scenario-designer/componentsReactFlow/map/RightPanel/RightPanel.tsx'
import LeftPanel from '@app/scenario-designer/componentsReactFlow/map/LeftPanel/LeftPanel.tsx'

// граф/утилиты
import {edgeTypes} from "@app/scenario-designer/core/contracts/types/edgeTypes.ts";
import {isAnyBranchResizing} from "@app/scenario-designer/core/branchResize/branchResizeGuard.ts";
import {createIsValidConnection} from "@app/scenario-designer/core/edgeMove/isValidConnection.ts";
import {ALLOW_MAP, TARGET_ALLOW_MAP} from "@app/scenario-designer/core/edgeMove/connectionRules.ts";

// вынесенные сервисы/хуки
import { HoverBranchService } from '@app/scenario-designer/core/handlers/HoverBranchService.ts'
import { NodeDragStopHandler } from '@app/scenario-designer/core/handlers/NodeDragStopHandler.ts'
import { ConnectionHandler } from '@app/scenario-designer/core/handlers/ConnectionHandler.ts'
import { makeOnNodesChange } from '@app/scenario-designer/core/handlers/NodesChangeHandler.ts'
import { useEdgesRef, useIsValidConnection } from '@app/scenario-designer/core/hooks/useConnectionValidation.ts'
import { useFitViewOnVersion } from '@app/scenario-designer/core/hooks/useFitViewOnVersion.ts'
import { useBranchSizeValidation } from '@app/scenario-designer/core/hooks/useBranchSizeValidation.ts'
import { omitNodeProps } from '@app/scenario-designer/core/utils/omitNodeProps.ts'
...
import {useConnectContext} from "@app/scenario-designer/core/hooks/useConnectContext.ts";
import {
    absOf,
    ensureParentBeforeChild,
    pickDeepestBranchByTopLeft,
    rectOf
} from "@app/scenario-designer/core/utils/dropUtils.ts";
